...
import com.example.cnpmnc_bandienthoaionl.ThongTinDonHangFragment;
                        ...
                        holder.select.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                            ...
                            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                                if (compoundButton.isChecked()) {
                                    vnd.setText(gioHang.getGiaGioHang() + " $");
...
//        }
    ...
    public static class GioHangViewHolder extends RecyclerView.ViewHolder {
        ...
        public GioHangViewHolder(View view) {
            ...
            ten =view.findViewById(R.id.tengh);
            gia = view.findViewById(R.id.giagh);
            anh = view.findViewById(R.id.anhgh);
