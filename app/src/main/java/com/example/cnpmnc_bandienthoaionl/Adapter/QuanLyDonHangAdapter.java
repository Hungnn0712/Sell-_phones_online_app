...
public class QuanLyDonHangAdapter extends RecyclerView.Adapter<QuanLyDonHangAdapter.QuanLyDonHangViewHolder> {
    ...
    @NonNull
    @Override
    public QuanLyDonHangViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_quanlydh,parent,false);
        return new QuanLyDonHangViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull QuanLyDonHangViewHolder holder, int position) {
        ...
        holder.box.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View v1 = layoutInflater.inflate(R.layout.item_chinhsuadonhang, null);
                builder.setView(v1);
    ...
    class QuanLyDonHangViewHolder extends RecyclerView.ViewHolder{
        TextView tendh,giadh,tragthai;
        ImageView anh;
        Button box;
        public QuanLyDonHangViewHolder(@NonNull View view) {
            super(view);
