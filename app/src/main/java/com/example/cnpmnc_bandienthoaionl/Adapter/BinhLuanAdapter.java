...
public class BinhLuanAdapter extends FirebaseRecyclerAdapter<BinhLuan, BinhLuanAdapter.BinhLuanViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull BinhLuanViewHolder holder, int position, @NonNull BinhLuan binhLuan) {
        ...
        if (sosaodau == 1){
            ...
            holder.sao.setImageResource(R.drawable.basao);
        }if (sosaodau == 4){
    ...
    class BinhLuanViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView sao;
        public BinhLuanViewHolder(@NonNull View view) {
            super(view);
