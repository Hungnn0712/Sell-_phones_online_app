...
import com.example.cnpmnc_bandienthoaionl.Adapter.BinhLuanAdapter;
import com.example.cnpmnc_bandienthoaionl.Adapter.SanPhamLienQuanAdapter;
import com.example.cnpmnc_bandienthoaionl.Fragment.GioHangFragment;
import com.example.cnpmnc_bandienthoaionl.entity.BinhLuan;
...
public class ChiTietDienThoaiFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("MyApp", "Giá trị của code là: " + key);
...
//        anhct.setImageBitmap(bm);
        ...
        muahang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentManager fmgr = getActivity().getSupportFragmentManager();
                Bundle bundle = new Bundle();
                bundle.putString("keyDT", gioHang.getKeyDT());
                fragment.setArguments(bundle);
                FragmentTransaction ft = fmgr.beginTransaction();
                ft.replace(R.id.content_frame, fragment);
                ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_chi_tiet_dien_thoai, container, false);
    }
}